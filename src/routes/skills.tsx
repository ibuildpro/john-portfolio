...
export const Route = createFileRoute("/skills")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Architecture, backend, frontend, data, cloud, identity, APIs and AI — capabilities sharpened across sixteen years of enterprise delivery." },
      { property: "og:title", content: "Skills — Johnathan Hyde" },
      { property: "og:description", content: "Capabilities across architecture, data, cloud, identity, and AI." },
...
const groups = [
  {
    ...
    items: ["Full-stack design", "SaaS & multi-tenant", "ERP architecture", "Domain modelling", "Workflow systems", "Source-of-truth reporting"],
  },
  {
    n: "02",
    title: "Backend",
    lead: "Service layers that are boring to operate and clear to extend.",
    items: ["C# · ASP.NET Core", "Node.js · TypeScript", "Python · FastAPI", "REST APIs · Swagger", "Background workers", "Domain events"],
  },
  {
    n: "03",
    title: "Frontend",
    lead: "Interfaces that respect the work being done in them.",
    items: ["React · Next.js", "Angular", "TypeScript", "Design systems", "Accessibility", "Operational UI"],
  },
  {
    n: "04",
    title: "Data",
    lead: "Models, queries, and reports the business can defend.",
    items: ["PostgreSQL · SQL Server · MySQL", "Database design", "Entity Framework · Prisma · TypeORM", "Reconciliation & reporting", "Supabase"],
  },
  {
    n: "05",
    title: "Cloud & Delivery",
    lead: "Pipelines and infrastructure with sane defaults.",
    items: ["Microsoft Azure", "AWS", "Docker · Kubernetes", "Terraform", "Jenkins · Git", "Release engineering"],
  },
  {
    n: "06",
    title: "Identity & APIs",
    lead: "Permissions that mirror real responsibility.",
    items: ["Microsoft Entra ID", "Role-based access", "API integration", "Webhook design", "OAuth flows"],
  },
  {
    n: "07",
    title: "Applied AI",
    lead: "AI as a feature — reviewable, traceable, and bounded.",
    items: ["OpenAI API", "LLM application design", "LangChain", "Retrieval pipelines", "Human-in-the-loop"],
  },
];
        ...
        {groups.map((g) => (
          <div key={g.title} className="bg-background grid md:grid-cols-12 gap-8 p-8 md:p-12">
            <div className="md:col-span-4">
              ...
              <p className="mt-3 text-sm text-muted-foreground max-w-xs leading-relaxed">{g.lead}</p>
            </div>
